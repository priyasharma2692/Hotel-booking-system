import './Header.css'
import {faBed, faCalendarDays, faCar, faPerson, faPlane, faStar, faTaxi} from "@fortawesome/free-solid-svg-icons";
    ...
    return(
        <div className='header'>
            ...
            <p className='headerDesc'>
                Get rewarded for your tarvels - unlock instant savings of 10% or more
